...
@class FLTSelectTrackMessage;
@class FLTGetAvailableTracksMessage;
...
@interface FLTSelectTrackMessage : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
...
@interface FLTGetAvailableTracksMessage : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
...
@property(nonatomic, copy, nullable) NSString * selectedTrack;
@end
...
/// @return `nil` only when `error != nil`.
- (nullable FLTGetAvailableTracksMessage *)getAvailableTracks:(FLTTextureMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
- (void)selectTrack:(FLTSelectTrackMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
@end
