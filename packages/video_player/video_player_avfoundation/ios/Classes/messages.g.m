...
@interface FLTSelectTrackMessage ()
+ (FLTSelectTrackMessage *)fromList:(NSArray *)list;
+ (nullable FLTSelectTrackMessage *)nullableFromList:(NSArray *)list;
- (NSArray *)toList;
@end

@interface FLTGetAvailableTracksMessage ()
+ (FLTGetAvailableTracksMessage *)fromList:(NSArray *)list;
+ (nullable FLTGetAvailableTracksMessage *)nullableFromList:(NSArray *)list;
- (NSArray *)toList;
@end
...
@implementation FLTSelectTrackMessage
+ (instancetype)makeWithTrack:(NSString *)track
    textureId:(NSNumber *)textureId {
  FLTSelectTrackMessage* pigeonResult = [[FLTSelectTrackMessage alloc] init];
...
+ (FLTSelectTrackMessage *)fromList:(NSArray *)list {
  FLTSelectTrackMessage *pigeonResult = [[FLTSelectTrackMessage alloc] init];
  pigeonResult.track = GetNullableObjectAtIndex(list, 0);
  NSAssert(pigeonResult.track != nil, @"");
  pigeonResult.textureId = GetNullableObjectAtIndex(list, 1);
  NSAssert(pigeonResult.textureId != nil, @"");
  return pigeonResult;
}
+ (nullable FLTSelectTrackMessage *)nullableFromList:(NSArray *)list {
  return (list) ? [FLTSelectTrackMessage fromList:list] : nil;
}
- (NSArray *)toList {
  return @[
    (self.track ?: [NSNull null]),
    (self.textureId ?: [NSNull null]),
  ];
}
@end

@implementation FLTGetAvailableTracksMessage
+ (instancetype)makeWithTracks:(NSArray<NSString *> *)tracks
    selectedTrack:(nullable NSString *)selectedTrack {
  FLTGetAvailableTracksMessage* pigeonResult = [[FLTGetAvailableTracksMessage alloc] init];
  pigeonResult.tracks = tracks;
  pigeonResult.selectedTrack = selectedTrack;
  return pigeonResult;
}
+ (FLTGetAvailableTracksMessage *)fromList:(NSArray *)list {
  FLTGetAvailableTracksMessage *pigeonResult = [[FLTGetAvailableTracksMessage alloc] init];
  pigeonResult.tracks = GetNullableObjectAtIndex(list, 0);
  NSAssert(pigeonResult.tracks != nil, @"");
  pigeonResult.selectedTrack = GetNullableObjectAtIndex(list, 1);
  return pigeonResult;
}
+ (nullable FLTGetAvailableTracksMessage *)nullableFromList:(NSArray *)list {
  return (list) ? [FLTGetAvailableTracksMessage fromList:list] : nil;
}
- (NSArray *)toList {
  return @[
    (self.tracks ?: [NSNull null]),
    (self.selectedTrack ?: [NSNull null]),
  ];
}
@end
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 129: 
      return [FLTGetAvailableTracksMessage fromList:[self readValue]];
    case 130: 
    ...
    case 134: 
      return [FLTSelectTrackMessage fromList:[self readValue]];
    case 135: 
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[FLTCreateMessage class]]) {
  ...
  } else if ([value isKindOfClass:[FLTGetAvailableTracksMessage class]]) {
    [self writeByte:129];
    [self writeValue:[value toList]];
    ...
    [self writeByte:133];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[FLTSelectTrackMessage class]]) {
    [self writeByte:134];
    [self writeValue:[value toList]];
...
void FLTAVFoundationVideoPlayerApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLTAVFoundationVideoPlayerApi> *api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AVFoundationVideoPlayerApi.getAvailableTracks"
        binaryMessenger:binaryMessenger
        codec:FLTAVFoundationVideoPlayerApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getAvailableTracks:error:)], @"FLTAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(getAvailableTracks:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        FLTTextureMessage *arg_msg = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        FLTGetAvailableTracksMessage *output = [api getAvailableTracks:arg_msg error:&error];
        callback(wrapResult(output, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AVFoundationVideoPlayerApi.selectTrack"
        binaryMessenger:binaryMessenger
        codec:FLTAVFoundationVideoPlayerApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(selectTrack:error:)], @"FLTAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(selectTrack:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        FLTSelectTrackMessage *arg_msg = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api selectTrack:arg_msg error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
