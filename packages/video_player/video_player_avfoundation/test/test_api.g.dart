...
class _TestHostVideoPlayerApiCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is CreateMessage) {
    ...
    } else if (value is GetAvailableTracksMessage) {
      buffer.putUint8(129);
      writeValue(buffer, value.encode());
      ...
      buffer.putUint8(133);
      writeValue(buffer, value.encode());
    } else if (value is SelectTrackMessage) {
      buffer.putUint8(134);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 129: 
        return GetAvailableTracksMessage.decode(readValue(buffer)!);
      case 130: 
      ...
      case 134: 
        return SelectTrackMessage.decode(readValue(buffer)!);
      case 135: 
...
abstract class TestHostVideoPlayerApi {
  ...
  static void setup(TestHostVideoPlayerApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.AVFoundationVideoPlayerApi.getAvailableTracks', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, null);
      } else {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.getAvailableTracks was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final TextureMessage? arg_msg = (args[0] as TextureMessage?);
          assert(arg_msg != null,
              'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.getAvailableTracks was null, expected non-null TextureMessage.');
          final GetAvailableTracksMessage output = api.getAvailableTracks(arg_msg!);
          return <Object?>[output];
        });
      }
    }
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.AVFoundationVideoPlayerApi.selectTrack', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, null);
      } else {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.selectTrack was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final SelectTrackMessage? arg_msg = (args[0] as SelectTrackMessage?);
          assert(arg_msg != null,
              'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.selectTrack was null, expected non-null SelectTrackMessage.');
          api.selectTrack(arg_msg!);
          return <Object?>[];
        });
      }
    }
